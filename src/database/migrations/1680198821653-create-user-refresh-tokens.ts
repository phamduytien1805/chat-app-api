...
export class createUserRefreshTokens1680198821653
  implements MigrationInterface
{
  name = 'createUserRefreshTokens1680198821653';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_refresh_tokens" ADD CONSTRAINT "FK_15ffbf3cf712c581611caf2130a" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
